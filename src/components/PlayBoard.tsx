  ...
  return (
    ...
    >
      ...
      <AnimatePresence mode="wait">
        {activeQuestion && (hostParams?.firstBuzz || (gameState.settings?.timerEnabled && timerValue !== null && displayStage === 'question')) && (
          <motion.div 
            key="fixed-controls"
            ...
            exit={{ opacity: 0, y: -10 }}
            transition={{ duration: 0.2 }}
            className="fixed top-8 left-1/2 -translate-x-1/2 z-[80] flex items-center justify-center gap-4 w-full px-4 pointer-events-none"
          >
